...
- Create Angular project with ng: `ng new loansimulator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`loansimulator.client.esproj`).
